...
Tags: WordPress spell check, Find Empty Fields, website spelling, SEO plugin, improve SEO, spell check, spell checker, WordPress spell checker, spelling errors, spelling mistakes, spelling report, fix spelling, WP Spell Check, spellcheck, spellchecker, wp spellcheck, WordPress spelling, Find Lorem Ipsum, Lorem Ipsum, WooCommerce, WP eCommerce
...
WP Spellcheck is designed to scan and report Spelling Errors & Empty Fields throughout your WordPress website
== License ==

Copyright: © 2016 [Persyo](http://www.persyo.com/) (coded in CANADA)

A powerful plug-in designed to report Spelling Errors & Empty Fields throughout your WordPress website

== Description ==
WP Spell Check scans your WordPress website for Spelling Errors and Empty Fields and gives you the ability to view and fix the found errors quickly and easily. The free version can check 500 pages and 500 posts while the premium version can check your entire website for Spelling Errors and Empty Fields.

WP Spell Check 5 x Options intro

https://www.youtube.com/watch?v=d-1PHuMWO40

How to improve WordPress SEO through Empty Fields - WP Spell Check 5.x

https://www.youtube.com/watch?v=lXX_bLFy6yE

How to Fix WordPress Spelling errors with WP Spell Check 5.x

https://www.youtube.com/watch?v=w03kNKuHwsU
...
4. Click on WP Scanner and run a scan for spelling errors or Empty Fields
...
= What are empty fields? Why should I bother finding them? =

Empty fields are fields on various areas of your website that would normally be filled out to help your SEO. Finding them and filling them out will help you improve your SEO rankings.
...
= Why isn't the scan finishing on my websites? =

This is an error that can happen as a result of insufficient PHP memory on the server.  To confirm this, check your server's PHP error log.  If a scan is not cmpleting due to memory limits, To stop it, click on Stop Scan 
...
Check with your hosting provider to see what is the maximum amount of memory available on your server.
...
= I have Pro version & I noticed errors not showing up in the scan results. How come it's not being picked up? =

The PRO version will scan the first 1000 pages and posts on your website. If you have more pages on your website, the remaining pages and posts will not be checked for errors. If you need to scan more, the Enterprise version will scan an unlimited number of pages and posts. You can upgrade to Enterprise from within your account while you are logged in. 
...
1. The WP Spell Check Scan Results Page
2. The WP Spell Check Empty Fields Scan Results Page
3. The WP Spell Check General Options
4. The WP Spell Check Spellcheck Options
5. The WP Spell Check Empty Field Options
6. The WP Spell Check Ignore List page
7. The WP Spell Check My Dictionary Page
8. The WP Spell Check Pro Scan Results Page
9. The WP Spell Check Dashboard Widget
...
- Checked compatibility for WordPress 4.7
...
- Shortcodes that are not funtional will now be shown in the results list as a single spelling error
...
= 4.9 =
- Added new feature to scan Blog authors, main Sitetitle and Tagline (it comes up under athor scan)
...
- Fixed an issue where the update notice would show up on the latest version
...
= 2.2 =
- Added menu for [tutorials](https://www.wpspellcheck.com/tutorials/) on WP Spell Check
