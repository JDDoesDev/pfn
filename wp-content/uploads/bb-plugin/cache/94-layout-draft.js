...
var wpAjaxUrl='http://wpfood.local/wp-admin/admin-ajax.php';var flBuilderUrl='http://wpfood.local/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://wpfood.local/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://wpfood.local/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
